...
\begin{center}
\includegraphics[scale=0.5]{typing.PNG}
\end{center}
...
\noindent Documentation: Courte mais complète

\noindent Ecosystème: Puisqu'il s'agit d'un UI, le fonctionnement du shell reste en principe le même.
